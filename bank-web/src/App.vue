...
<template>
  <header style="display: flex; flex-direction: row; justify-content: space-around">
    ...
    <div style="display: flex; flex-direction: column; font-size: 1.1rem; cursor: pointer">
      <div
        v-if="!auth.isAuthenticated && !(route.name === 'auth')"
        style="color: blue"
  ...
  <div style="padding: 7rem 5rem; display: flex; justify-content: center">
    <RouterView />
  </div>
</template>
